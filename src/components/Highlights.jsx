      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          {highlights.map((highlight, index) => (
            ...
            >
              <div
                className={`w-20 h-20 mx-auto rounded-2xl bg-linear-to-br ${highlight.color} flex items-center justify-center mb-6 shadow-lg`}
              >
                <highlight.icon className="text-3xl text-white" />
              </div>
              <div
                className={`text-5xl font-extrabold bg-linear-to-r ${highlight.color} bg-clip-text text-transparent mb-3`}
              >
                {highlight.stat}
              </div>
