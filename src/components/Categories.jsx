...
import { FaUniversity, FaFlask, FaPalette, FaLaptopCode, FaHeartbeat, FaBalanceScale, FaMoneyBillWave, FaGlobeAmericas } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          {categories.map((category, index) => (
            ...
            >
              <div className={`w-16 h-16 mx-auto rounded-xl bg-gradient-to-br ${category.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-block px-8 py-4 rounded-xl font-semibold bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg hover:shadow-2xl transition-all duration-300"
          >
            View All Categories
          </motion.a>
        </motion.div>
