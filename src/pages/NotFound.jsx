    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-4xl w-full text-center">
        <div className="relative">
          ...
          <div className="relative">
            <h1 className="text-[180px] md:text-[250px] font-black text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-accent leading-none animate-bounce">
              404
            </h1>
        ...
        <div className="mt-8 space-y-4">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            The scholarship you're looking for seems to have gone on a study break. 
          ...
          <div className="pt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              to="/scholarships"
              className="btn btn-secondary gap-2 min-w-[200px]"
            >
              <FaSearch />
              Browse Scholarships
            </Link>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          <Link to="/" className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
          ...
          <Link to="/scholarships" className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
            <div className="card-body items-center text-center">
          ...
          <Link to="/dashboard" className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
            <div className="card-body items-center text-center">
        ...
        <div className="mt-12 text-sm text-gray-500">
          <p>Lost? Try searching for scholarships or contact our support team.</p>
        </div>
      </div>
    </div>
  );
